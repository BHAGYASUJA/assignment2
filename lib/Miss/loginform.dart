import 'package:assignment3/Miss/login.dart';
import 'package:assignment3/Miss/signup.dart';
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Welcome To Our App",textAlign: TextAlign.center,style: TextStyle(color: Colors.grey),),
            ),
            Image.network('https://images.unsplash.com/photo-1542282088-fe8426682b8f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80'),
            Padding(
